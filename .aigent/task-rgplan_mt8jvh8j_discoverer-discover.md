...
- Discover existing regression coverage: Inspect existing regression tests, page objects, fixtures, utilities, Testpad scripts under the Regression Test Template, similar flows, CI/CD, and Jenkins jobs. Produce: Existing Coverage, Reusable Components, Existing Test Data, Missing Coverage, Files Expected to Change, Potential Risks. Generate cases for the named flows — do not copy every script in the template.
